 ...
 * @author Fluidscapes
 */
public class RemoveCRAction extends org.apache.struts.action.Action {
...
//            System.out.println("tag:-" + request.getParameter("tag"));
            ...
            if(type.equals("pdf")){
            selectQuery = "UPDATE tbl_news_dataentry SET  docpath = REPLACE(docpath, ? ,'') where  workcode =?";
        }
            else if(type.equals("img")){
            selectQuery = "UPDATE tbl_news_dataentry SET  graphicspath = REPLACE(graphicspath, ? ,'') where  workcode =?";
        }
            else if(type.equals("vdo")){
            selectQuery = "UPDATE tbl_news_dataentry SET  vdopath = REPLACE(vdopath, ? ,'') where  workcode =?";
        }
