 ...
 * @author Fluidscapes
 */
public class ApproverUpdateAction extends org.apache.struts.action.Action {
...
//                pstmtData.setString(1, tag);
                ...
                if (pstmtData.executeUpdate() > 0) {
                    String removeQuery = "delete from tbl_temp_tag_master where idtbl_temp_tag_master=?";
                    PreparedStatement pstmtRemove = dh.prepareStatement(removeQuery);
                    pstmtRemove.setString(1, id);
                    pstmtRemove.executeUpdate();

                    response.sendRedirect("dataentry_approver_reviewapprove.jsp?searchresult=N&exist&tag=" + tag);
...
//                    pstmtData.setString(1, tag);
                    ...
                    response.sendRedirect("dataentry_approver_reviewapprove.jsp?searchresult=N&success");
                }
            }
