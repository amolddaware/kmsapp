 ...
 * @author Fluidscapes
 */
public class TextNewsUpdateAction extends org.apache.struts.action.Action {
...
//            System.out.println(request.getParameter("subject"));
                ...
                String subject = null,fromdate=null,todate=null, desc = null,importance=null, hour = null, minute = null, ampm = null, timestamp = null, additional = null, summary = null, sourcedate, titlemarathi = null, sentiment = null, tempvideo = null, channel = null;
...
//            String datetime[]=vpath.split("_");
                try {
                    ...
                    String updateData = "update tbl_news_dataentry set subject=?,description=?,link=?, "
                            + "titlemarathi=?,sentiment=?,timestamp=?,chname=?,additionaltag=?,sourcedate=?,importance=? where workcode=? ";
                    ...
                    pstmtupData.setString(4, titlemarathi);
...
//                   
//                } else {
                     response.sendRedirect("em_newsedit.jsp?workcode=" + workcode + "&fromdate="+fromdate+"&todate="+todate+"&success");
