...
import static org.mygov.handler.SendMailGov.SendLocal;

public class SendMailGov_old {
...
//         final String user = "cmfellow1.cmo";//change accordingly  
        final String password = "*Ku9^GN69KU";
//        final String password = "Nagpur@123";
         String ccEmail="amol@fluidscapes.in";
        
//        final String password = "CMFP@2017";
//         String to = "prasad.bhoi@gov.in";
//         String to = "prasadbhoi91@gmail.com";
        String to = "amoldaware@ymail.com";
        Security.addProvider(new com.sun.net.ssl.internal.ssl.Provider());
        final String SSL_FACTORY = "javax.net.ssl.SSLSocketFactory";
        // Get a Properties object
        Properties props = System.getProperties();
        props.setProperty("mail.smtps.host", "mail.gmail.com"); //change this to your email host if using mail exchanger then use ip of that server
        props.setProperty("mail.smtp.socketFactory.class", SSL_FACTORY);
        props.setProperty("mail.smtp.socketFactory.fallback", "false");
        props.setProperty("mail.smtp.port", "465");  // use port 465 for ssl / 25 for exchanger
     ...
     public static void main(String[] args) throws MessagingException, AddressException, IOException {
        SendLocal("amoldaware@ymail.com", "Amol", "12345");
    }
}
