...
//        TwitterMain poIex2 = new TwitterMain();
...
//        String fileName = "D:\\testreport.xlsx";
    ...
    public boolean readFile(String fileName, String userid,String sourcedate,String schedule,String date11, String ipAddress,String keyword) throws FileNotFoundException, IOException, ClassNotFoundException, SQLException, ServletException {
        FileInputStream fis;
        try {
