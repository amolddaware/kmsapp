 ...
 * @author Fluidscapes
 */
public class RemoveImageAction extends org.apache.struts.action.Action {
...
//            PrintWriter out = response.getWriter();
            ...
            String selectQuery = "UPDATE tbl_news_dataentry SET  graphicspath = REPLACE(graphicspath, ? ,'') WHERE userid =?";
