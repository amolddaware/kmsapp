                                    ...
                                    <div class="col-md-10 col-lg-offset-1 well">
                                        ...
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane fade in active" id="information">
                                                ...
                                                <section>
                                                    <div>
                                                        <form class="form-horizontal m-t-50" action="<%=request.getContextPath()%>/addgr.do"  id="uploadform" method="post" accept-charset="UTF-8" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <div class="form-line">
                                                                    <select  class="form-control " name="dept" id="dept" onchange="getMarathi(this.value);errBlank('errDept')"  required>
                                                                ...
                                                                <span id="errDept" class="text-danger"></span>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <div class="form-line">
                                                                    <input type="text" class="form-control" id="titlemarathi" name="titlemarathi" placeholder="Title (Marathi)" oninput="errBlank('errTitlemarathi')"  >
                                                                    <!--<textarea class="form-control" id="description" name="description" autocomplete="off" oninput="errorBlank('errDescription')" placeholder="Enter Description " rows="3" required></textarea>-->
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <div class="form-line">
                                                                    <input type="text" class="form-control" id="grcode" onkeydown="return NumberOnly(event)" onkeypress="return NumberOnly(event)" onkeyup="return NumberOnly(event)" name="grcode" placeholder="GR Code" oninput="errBlank('errGrcode')"  >
                                                                    <!--<textarea class="form-control" id="description" name="description" autocomplete="off" oninput="errorBlank('errDescription')" placeholder="Enter Description " rows="3" required></textarea>-->
                                                        ...
                                                        <div class="form-group">
                                                            <label for="Upload" class="col-sm-3 control-label">Upload PDF file </label>
                                                            <div class="col-sm-9">
                                                                <div class="form-line">
                                                                    <!--<div class="col-lg-9 form-control"  style="display: none;" >-->
                                                                    <input type="file" id="upload" name="upload" accept=".pdf,.PDF"  class="form-control" onchange="errBlank('errFile')" placeholder="Upload Image" autocomplete="off"  />
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-sm-12 text-right">
                                                                <button class="btn btn-danger" onclick="return saveGRSubmitBtnInfo();" >SAVE</button>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
                ...
                <div class="modal-dialog  m-t-125 " role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-center">
                            ...
                            <p class="text-success semi-bold" style="font-size:18px">Generated GR Reference Number  is:-<%=workcode%> </p>
                        ...
                        <div class="modal-footer">
                            <!--<a >TAG</a>-->
                            <a href="gr_add.jsp"> <button type="button" class="btn btn-link waves-effect"  data-dismiss="#myModel1" >CLOSE</button></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script type="text/javascript">
            ...
            function saveGRSubmitBtnInfo() {
                ...
                if (document.getElementById("dept").value == "") {
                    ...
                    document.getElementById("errDept").innerHTML = "Please select Department";
                ...
                if (document.getElementById("grcode").value == "") {

                    document.getElementById("errGrcode").innerHTML = "Enter enter GR Code";
                    document.getElementById("grcode").focus();
                    return false;
                }
