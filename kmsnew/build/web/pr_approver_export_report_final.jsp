...
<html lang=en>
    <head>
        ...
        <title>Print Media Report</title>
            ...
            <div class=panel-group id=accordion_1 role=tablist aria-multiselectable=true>
                <div class="panel panel-primary">
                    <div class=panel-heading role=tab id=headingOne_1>
                        <h4 class=panel-title> <a role=button data-toggle=collapse data-parent=#accordion_1 href=#collapseOne_1 aria-expanded=true aria-controls=collapseOne_1 onclick=""> <span class="glyphicon glyphicon-menu-right"></span>Print Media Filters </a> </h4>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-8 col-sm-offset-2">
                                ...
                                <%
                                    ...
                                    String sql = "SELECT * FROM tbl_news_dataentry  " + query + "  ORDER BY CASE WHEN workcode LIKE '%P%' THEN 1	WHEN workcode LIKE '%W%'  THEN 2 ELSE 3 END ";

//                                    String sql = "SELECT graphicspath,workcode,brand,location,district,language,npname,edition,subedition,subject,titlemarathi,sourcedate,sentiment,link  FROM tbl_news_dataentry  " + query + " and workcode like ? and npname is not null  group by npname,subject,titlemarathi,sourcedate order by npname ";
//                                    String sql = "SELECT graphicspath,workcode,brand,location,district,language,npname,edition,subedition,subject,titlemarathi,sourcedate,sentiment,link  FROM tbl_news_dataentry  " + query + " and workcode like ? and npname is not null  group by npname,subject,titlemarathi,sourcedate order by npname ";
//                                    String sql = "SELECT graphicspath,workcode,brand,location,language,npname,edition,subedition,subject,titlemarathi,sourcedate,sentiment,link  FROM tbl_news_dataentry  " + query + " and workcode like ? and npname is not null and graphicspath!=''  group by npname,subject,titlemarathi,sourcedate order by npname ";
...
//                                    stm.setString(1, "%P%");
                                ...
                                <div class="col-sm-12 padding-0">
                                    <div class="col-sm-offset-3 col-sm-6 text-center cover_data text-capitalize">
                                        <h1>KMS REPORT</h1>
                                        <hr class="hr_dashed">
                                        <h2 class="text-capitalize">Print Media</h2>
                                        <hr class="hr_dashed">
                                        <h3>Search By:                                                
                                ...
                                <div class="col-sm-12 padding-0">
                                    <div class="body-main inner ">
                                        <div class="row">
                                            <div class="col-sm-8">
                                                <h4 style="color: #009fe2;"><strong>Web Media Report</strong></h4>
                                                <!--                                                <p>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4 m-b-15"> 
                                                        ...
                                                        <img class="npnameImg img-responsive" src="images/epaper/Navbharat_times.png" alt="<%=rs.getString("npname")%>" width="200">
                                                        <%} else {%>
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td style="width:70%"><% if (rs.getString("link") != null) {%>
                                                                                <a href="<%=rs.getString("link")%>" style="color:blue" target="_blank"><%=rs.getString("link")%> </a>
                                ...
                                <div class="col-sm-12 padding-0">
                                    <div class="body-main inner ">
                                        <div class="row">
                                            <div class="col-sm-8">
                                                <h4 style="color: #009fe2;"><strong>Print Media Report</strong></h4>
                                                <!--                                                <p>
                                                                                                    <strong>From: 2017-04-24</strong><br>
                                                                                                    <strong>To: 2020-04-24</strong></p>-->
                                            </div>
                                                            ...
                                                            <div class="card-body">
                                                                <table class="table table-responsive d-md-table mb-0">
                                                                    <tbody>
                                                                        ...
                                                                        <%} else if (rs.getString("district") != null) {%>
                                                                        <tr>
                                                                            <td><strong>District</strong></td>
                                                                            <td><% if (rs.getString("district") != null) {%><%=rs.getString("district")%><%}%> </td>
                                                                        </tr>
