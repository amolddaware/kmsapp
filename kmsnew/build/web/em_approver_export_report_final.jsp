...
<html lang=en>
    <head>
        ...
        <title>Electronic Media Report</title>
            ...
            <div class=panel-group id=accordion_1 role=tablist aria-multiselectable=true>
                <div class="panel panel-primary">
                    <div class=panel-heading role=tab id=headingOne_1>
                        <h4 class=panel-title> <a role=button data-toggle=collapse data-parent=#accordion_1 href=#collapseOne_1 aria-expanded=true aria-controls=collapseOne_1 onclick=""> <span class="glyphicon glyphicon-menu-right"></span>Electronic Media Filters </a> </h4>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-8 col-sm-offset-2">
                                ...
                                <%
                                    ...
                                    String sql = "SELECT subject,titlemarathi,description,chname,sentiment,sourcedate,vdopath,graphicspath, additionaltag,startdatetime,enddatetime FROM tbl_news_dataentry  " + query + " and workcode like ? order by chname  ";
                                ...
                                <div class="col-sm-12 padding-0">
                                    <div class="col-sm-offset-3 col-sm-6 text-center cover_data text-capitalize">
                                        <h1>KMS REPORT</h1>
                                        <hr class="hr_dashed">
                                        <h2 class="text-capitalize">Electronic Media</h2>
                                        <hr class="hr_dashed">
                                        <h3>Search By:                                                
                                ...
                                <div class="col-sm-12 padding-0">
                                    <div class="body-main inner ">
                                        <div class="row">
                                            <div class="col-sm-8">
                                                <h4 style="color: #009fe2;"><strong>Electronic Media Report</strong></h4>
                                                <!--                                                <p>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4 m-b-15"> 
                                                        ...
                                                        <%if (rs.getString("startdatetime") != null) {%>
