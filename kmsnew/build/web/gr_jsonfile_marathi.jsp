...
//                String sql = "select subject from tbl_news_dataentry where subject like ?  ";
                String sql = "select titlemarathi from tbl_news_dataentry where titlemarathi like '%" + lastWord + "%' and workcode like '%G%' and titlemarathi is not null ";
...
//                pstmt.setString(1, "%P%");
                ...
                while (rs.next()) {
                    al.add(rs.getString("titlemarathi"));
                }
                if (rs != null) {
                    rs.close();
                }
