...
//                    dateQuery = " (str_to_date(sourcedate,'%d/%m/%Y') >='" + fromDate + "' AND str_to_date(sourcedate,'%d/%m/%Y') <='" + toDate + "')";
            ...
            try {
                if (session.getAttribute("role").equals("5")) {
                    String sql = "SELECT * from tbl_news_dataentry where " + dateQuery + " and  workcode not like ? and workocode like ? ";
                    ...
                    String sql = "SELECT * FROM tbl_news_dataentry where " + dateQuery + " and workcode not like ? and workcode like ?  and userid=?";
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <form action="em_videoviewdatewise.jsp" id="myForm" method="get">
...
<%--                                                <td>
                                                    <a hred="/kmsvdo/<%=rs.getString("sourcedate")%>" class="btn btn-danger btn-circle waves-effect waves-circle waves-float" data-toggle="modal" data-target="#defaultModal"> <i class="material-icons">play_arrow</i> </a>
                                                </td>--%>
                                            </tr>
                                            <%}%>
                                        </tbody>
