...
<%
    if (session != null && session.getAttribute("username") != null && (session.getAttribute("role").equals("6") || session.getAttribute("role").equals("2") || session.getAttribute("role").equals("5"))) {
