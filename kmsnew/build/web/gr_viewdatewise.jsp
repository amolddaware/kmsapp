...
<%
    if (session != null && session.getAttribute("username") != null && (session.getAttribute("role").equals("2") || session.getAttribute("role").equals("7") || session.getAttribute("role").equals("6") || session.getAttribute("role").equals("5"))) {
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <form action="gr_viewdatewise.jsp" id="myForm" method="get">
                                    ...
                                    <table id="example"  class="table table-bordered table-striped table-hover ">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <% if (session.getAttribute("role").equals("5")) {%>
                                                    <a href="gr_edit.jsp?workcode=<%=rs.getString("workcode")%>" title="Click Here"  class="btn btn-warning waves-effect"> <%=number%> </a>
                                                    <%} else if (session.getAttribute("role").equals("7")) {%>
                                                    <%=number%> 
                                                    <%}%>
                                                </td>
                                                ...
                                                <td><a href="<%=rs.getString("docpath").substring(34).replace(" ", "%20")%>" target="_blank" title="Click Here to Download" download><img src="images/pdf.jpg" width="30" height="30"></a></td>
