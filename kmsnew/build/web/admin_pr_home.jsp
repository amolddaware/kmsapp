                                ...
                                <div class="content" style="max-height: 46vh;overflow: auto;">
                                 <div class="table-responsive">
                                        <table class="table table-bordered table-striped table-hovers" id="all_rows">
                                            <tbody>
                                                <%
                                                    String sqlSelects = "SELECT subject,additionaltag,graphicspath,sourcedate FROM tbl_news_dataentry where workcode like '%P%' order by iddataentry DESC limit 0,5 ";
