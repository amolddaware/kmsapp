...
//                String sql = "select subject from tbl_news_dataentry where subject like ?  ";
                String sql = "select place_of_program from tbl_news_dataentry where place_of_program like '%" + lastWord + "%' and workcode like '%C%' ";
...
//                pstmt.setString(1, "'%C%'");
                ...
                while (rs.next()) {
                    al.add(rs.getString("place_of_program"));
                }
                if (rs != null) {
                    rs.close();
                }
