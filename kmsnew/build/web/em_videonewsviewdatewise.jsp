...
//                    dateQuery = " (str_to_date(sourcedate,'%d/%m/%Y') >='" + fromDate + "' AND str_to_date(sourcedate,'%d/%m/%Y') <='" + toDate + "')";
            ...
            try {
//                if (session.getAttribute("role").equals("5")) {
                    String sql = "SELECT * from tbl_news_dataentry where " + dateQuery + " and  workcode like ? ";
            ...
            <div class="col-md-12"> 
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h2>Electronic Media Data Entry List</h2>
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <form action="em_videonewsviewdatewise.jsp" id="myForm" method="get">
                                    ...
                                    <table id="example"  class="table table-bordered table-striped table-hover ">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <%
                                                    if(rs.getString("workcode").contains("EN")){%>     
                                                    <a href="em_newsedit.jsp?workcode=<%=rs.getString("workcode")%>" title="Click Here"  class="btn btn-warning waves-effect"> <%=number%> </a>
                                                    <%}else if(rs.getString("workcode").contains("E")){%>
                                              
                                                    <a href="em_videoedit.jsp?workcode=<%=rs.getString("workcode")%>" title="Click Here"  class="btn btn-warning waves-effect"> <%=number%> </a>
                                                ...
                                                <td><%=rs.getString("sourcedate")%></td>
                                                 <td>
                                                     <%
                                                    if(rs.getString("workcode").contains("MN")){%>     
                                                    <a href="javascript:void(0)"  class="btn btn-default waves-effect" > <i class="material-icons">subject</i> </a>
                                                    <%}else if(rs.getString("workcode").contains("N")){%>
                                              
                                                   <a onclick="displayVdoFilesData('<%=rs.getString("workcode")%>')" class="btn btn-danger btn-circle waves-effect waves-circle waves-float" data-toggle="modal" data-target="#defaultModal"> <i class="material-icons">play_arrow</i> </a>
                                               
                                                <%}%><%--
                                                <td>
                                                    <a onclick="displayVdoFilesData('<%=rs.getString("vdopath")%>')" class="btn btn-danger btn-circle waves-effect waves-circle waves-float" data-toggle="modal" data-target="#defaultModal"> <i class="material-icons">play_arrow</i> </a>
                                                </td>--%>
