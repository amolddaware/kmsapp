    ...
    <body class="theme-blue">
        ...
        <%
            ...
            try {
                ...
                String sqlQuery = "SELECT workcode,subject,language,npname,district,titlemarathi,link,sourcedate FROM tbl_news_dataentry WHERE  userid=? and workcode like ? ";
                ...
                String sql = "SELECT workcode,subject,language,npname,district,titlemarathi,link,sourcedate FROM tbl_news_dataentry WHERE userid=? and workcode like ? limit 0,10";
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td >
                                                    ...
                                                    <p class="m-t-15 m-b-30"><%=rs.getString("district")%> </p>
                                                    <p class="m-t-15 m-b-30"><%=rs.getString("link")%> </p>
