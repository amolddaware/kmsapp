...
<nav class="navbar">
    <div class="container-fluid">
        ...
        <%--<div class="collapse navbar-collapse" id="navbar-collapse">
            <form action="pr_search.jsp" id="myForm" method="get">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a class="search_input" id="generalTag1">
                            <% if (request.getParameter("generaltagprint") != null) {
...
//                                    s = new String(generaltag.getBytes("ISO-8859-1"), "UTF-8");
                            ...
                            %>
                            <input class="form-control"  type="text" name="generaltagprint" value="<%=request.getParameter("generaltagprint")%>" id="generaltagprint" autocomplete="off"  oninput="errorBlank('errGeneral')" placeholder="Enter Keyword">

                            <%
                            } else {
                                //                        System.out.println("testsadadadasd:-");
                            %>
                            <input class="form-control"  type="text" name="generaltagprint" id="generaltagprint" autocomplete="off"  oninput="errorBlank('errGeneral')" placeholder="START TYPING...">
                            <%}%>
...
//                            System.out.println("tests:-" + request.getParameter("generaltag"));
    ...
    <script>
        function valHeader() {
            var general = document.getElementById("generaltagprint").value;
//    alert(general);
            if (general == "") {
//        alert("error");
                document.getElementById("errGeneral").innerHTML = "Please enter keyword";
                document.getElementById("generaltagprint").focus();
                return false;
