                ...
                <div class="col-md-12"> 
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="card">
                                <div class="header">
                                    <h2>ADD MULTIREC VIDEO INFORMATION</h2>
                                    ...
                                    <div class="col-md-10 col-lg-offset-1 well">
                                        ...
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane fade in active" id="information">
                                                ...
                                                <section>
                                                    <div>
                                                        <form class="form-horizontal m-t-30" action="<%=request.getContextPath()%>/newsupload.do"  id="uploadform" method="post" accept-charset="UTF-8">
...
//                                                                            ResultSet rs = null;
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-md-9 col-sm-offset-3">
                                                                ...
                                                                <div id="dragandrophandler1" ><small>Drag & Drop only single .mp4 Files Here</small>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-sm-12 text-right">
                                                                <button type="submit" class="btn btn-danger" data-toggle="modal" data-target="#defaultModal" onclick="return saveData()" id="btnSaveVideo"  disabled="true">SAVE</button>
                                                            </div>
                                                        </div>
                                                        <!--modal-->
            ...
            <div class="modal  m-t-125" id="sameEntry" tabindex="-1" role="dialog" style="display: none">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <a href="em_addvideoinformation.jsp"> <button type="button" class="btn btn-link waves-effect" data-dismiss="modal">CLOSE</button></a>
                        </div>
                    </div>
                </div>
            </div>
