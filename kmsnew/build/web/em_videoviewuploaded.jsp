...
//                    System.out.println("searchresult:-" + request.getParameter("searchresult"));
        ...
        try {
            ...
            String sqlQuery = "SELECT workcode,subject,description,graphicspath,vdopath,docpath,audiopath,sourcedate FROM tbl_news_dataentry WHERE  userid=? ";
//                    String sql = "SELECT workcode,subject,description,graphicspath,vdopath,docpath,audiopath FROM tbl_news_dataentry WHERE " + query + serchQuery ;
            String sql = "SELECT workcode,subject,description,graphicspath,vdopath,docpath,audiopath,sourcedate FROM tbl_news_dataentry WHERE userid=? limit 0,10";
                        ...
                        <div class="body clearfix">
                            <div class="table-responsive" id="all_rows">
                                <table class="table table-bordered table-striped table-hovers" id="all_rows">
                                    <tbody>
                                        <tr>
                                            <th colspan="2"><h3 class="text-center"> Video uploaded Information</h3></th>
                                        </tr>
                                        <%
                                            String sssss = null;
