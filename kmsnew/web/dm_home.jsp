...
<%
    ...
    if (session != null && session.getAttribute("username") != null && (session.getAttribute("role").equals("4") || session.getAttribute("role").equals("6") || session.getAttribute("role").equals("1"))) {
                                ...
                                <ul class="header-dropdown m-r--5">
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu pull-right">
                                            <li><a href="dm_add.jsp">ADD</a></li>
                                            <li><a href="dm_view.jsp?searchresult=D">EDIT</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="content" style="max-height: 46vh;overflow: auto;">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-hovers" id="all_rows">
                                        <tbody>
                                            <%
                                                String sqlSelect = "SELECT subject,dm_source,total_engagement,description,link,sourcedate FROM tbl_news_dataentry WHERE userid=? and workcode like '%D%' order by iddataentry DESC limit 0,5 ";
                                                ...
                                                while (rsSelect.next()) {
//                                                    System.out.println("rsSelect.getString():-" + rsSelect.getString("graphicspath"));
                                            ...
                                            <tr>
                                                ...
                                                <td><h4> <%=rsSelect.getString("subject")%>   </h4>
                                                    ...
                                                    <p class="m-t-15 m-b-30"><%=rsSelect.getString("dm_source")%> </p>
                                                    <p class="m-t-15 m-b-30"><%=rsSelect.getString("total_engagement")%> </p>
                                                    <p class="m-t-15 m-b-30"><a href="<%=rsSelect.getString("link")%>" target="_blank" ><%=rsSelect.getString("link")%></a> </p>
