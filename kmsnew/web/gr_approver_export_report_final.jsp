...
<html lang=en>
    <head>
        ...
        <title>Government Resolution Report</title>
            ...
            <div class=panel-group id=accordion_1 role=tablist aria-multiselectable=true>
                <div class="panel panel-primary">
                    <div class=panel-heading role=tab id=headingOne_1>
                        <h4 class=panel-title> <a role=button data-toggle=collapse data-parent=#accordion_1 href=#collapseOne_1 aria-expanded=true aria-controls=collapseOne_1 onclick=""> <span class="glyphicon glyphicon-menu-right"></span>Government Resolution Filters </a> </h4>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-8 col-sm-offset-2">
                                ...
                                <%
                                    ...
                                    String sql = "SELECT docpath,workcode,dept,deptmarathi,subject,titlemarathi,sourcedate,grcode  FROM tbl_news_dataentry  " + query + " and workcode like ? order by sourcedate desc ";
                                ...
                                <div class="col-sm-12 padding-0">
                                    <div class="col-sm-offset-3 col-sm-6 text-center cover_data text-capitalize">
                                        <h1>KMS REPORT</h1>
                                        <hr class="hr_dashed">
                                        <h2 class="text-capitalize">Government Resolution (GR)</h2>
                                        <hr class="hr_dashed">
                                        <h3>Search By:                                                
                                    ...
                                    <div class="body-main inner ">
                                        <div class="row">
                                           <div class="col-sm-12">
                                                <div class="row">
                                                    <div class="col-sm-8">
                                                        <h4 style="color: #009fe2;"><strong>Government Resolution Report</strong></h4>
