...
<%
    if (session != null && session.getAttribute("username") != null && (session.getAttribute("role").equals("6") || session.getAttribute("role").equals("3") || session.getAttribute("role").equals("7"))) {
...
<html lang="en">
    ...
    <body class="theme-blue">
        ...
        <%String getData = null, searchQuery = null, room = null, link = null;
            ...
            String sql = "SELECT * FROM tbl_news_dataentry where workcode like '%G%' ";
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><%=rs.getString("sourcedate")%></td>
                                                  ...
                                                  <td><a href="gr_edit.jsp?workcode=<%=rs.getString("workcode")%>" title="Click Here"  class="btn btn-warning waves-effect"> <i class="material-icons">edit</i> </a></td>
                                            </tr>
                                            <%}%>
                                        </tbody>
                                    </table>
