...
//     if(request.getParameter("fromSourceDate")!="null"){
//     response.sendRedirect("dataentry_approver_edit_printmedia_list.jsp?searchresult=P");
//     }
...
//                getData = request.getParameter("searchresult");
                room = "Print Media Dataentry List";
                link = "printmedia_dataentry_edit.jsp";
//                            link = "dataentry_edit_creative_info.jsp";
            } else if (session.getAttribute("role").equals("5")) {
//                getData = request.getParameter("searchresult");
                room = "Print Media Dataentry List";
                link = "printmedia_approver_dataentry_edit.jsp";
            }
            
            
            String sql = "SELECT * FROM total_printmedia_dataentry_view where (sourcedate<=? and sourcedate>=?) and  workcode like '%P%' and importance is null ";
        ...
        %><section class="content">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                   <form action="dataentry_approver_edit_printmedia.jsp" id="myForm" method="get">
                                                ...
                                                <table id="example"  class="table table-bordered table-striped table-hover ">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>  <%if (rs.getString("importance") != null) {%>
                                                                <%=rs.getString("importance")%><%} else {%>
                                                                -<%}%></td>
                                                            <td><%=rs.getString("sourcedate")%></td>

                                                            <td>  <% if (!rs.getString("imagepath").isEmpty()) {
            ...
            //                                                        String fullpath=path.substring(19);
                                                                ...
                                                                %>
                                                                <img src="<%=whiteSpace%>" width="70" height="70">
                                                                <%} else {%>
                                                                Upload Image 
                                                                <%}%>
                                                            </td>
                                                            <td><a href="<%=link%>?workcode=<%=rs.getString("workcode")%>&fromSourceDate=<%=request.getParameter("fromSourceDate")%>&toSourceDate=<%=request.getParameter("toSourceDate")%>" title="Click Here"  class="btn btn-warning waves-effect"> <i class="material-icons">edit</i></a></td>
                                                        </tr>
                                                        <%}%>
                                                    </tbody>
