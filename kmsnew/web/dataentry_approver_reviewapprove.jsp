...
<html lang="en">
    <head>
        ...
        <script>
            function saveReviewApproveData(val, id, workcode) {
//                                alert(val);
                var a = document.getElementById(val).value;
//                                alert(a);
                window.location.href = "<%=request.getContextPath()%>/approverupdate.do?tag=" + a + "&id=" + id + "&workcode=" + workcode;
//                var xmlhttp;
//               
...
//                alert(val);
    ...
    <body class="theme-blue">
        ...
        <%
            ...
            int number = 1;
            String sql1 = "SELECT a.* FROM temp_tag_view a where tag not IN (select tag from  tbl_tag_master b where a.tag=b.tag ) and a.tag <>'' ";
//            String sql1 = "SELECT a.workcode as workcode,a.subject,a.description,b.idtbl_temp_tag_master as idtbl_temp_tag_master,b.tag as tag FROM tbl_temp_tag_master b inner join tbl_news_dataentry a on a.workcode=b.workcode group by b.tag ";
            System.out.println("sql:-" + sql1);
            PreparedStatement stm1 = ConnectionDB.getDBConnection().prepareStatement(sql1);
            ...
            <div class="col-md-12"> 
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h2>Electronic Media Review / Approve Tag</h2>
                                    ...
                                    <!--<table  id="example" class="table table-bordered table-striped table-hover dataTable js-exportable">-->
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">  <a onclick="saveReviewApproveData('tag<%=rs1.getString("idtbl_temp_tag_master")%>', '<%=rs1.getString("idtbl_temp_tag_master")%>', '<%=rs1.getString("workcode")%>')" class="cursorpointer" ><i class="material-icons" style="font-size:20px;color:#15B2FE;cursor: pointer ">save</i></td>
                                            </tr>
                                            <%}%>
                                        </tbody> </table>
                                </div>
