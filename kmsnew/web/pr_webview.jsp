...
//            PrintWriter out = response.getWriter();
                ...
                String sql = "SELECT * FROM tbl_news_dataentry where workcode like ? and userid=?";
            ...
            <div class="col-md-12"> 
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h2>Web Media Dataentry List</h2>
                               ...
                               <div class="row clearfix">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <form action="pr_webviewdatewise.jsp" id="myForm" method="get">

                                        <div class="form-group">
                                            <!--<form action="approver_export_data.jsp" method="post">-->
                                            <div class="col-sm-4">
                                                <input type="text" id="date-start" name="fromSourceDate" class="form-control" placeholder="FROM DATE..." autocomplete="off">
                                            </div>
                                            <div class="col-sm-4">
                                                <input type="text" id="date-end" name="toSourceDate" class="form-control" placeholder="TO DATE..." autocomplete="off">
                                            </div>
                                            <!--                        </div>-->
                                            <div class="col-sm-4">
                                                <!--<br>-->
                                    ...
                                    <table  class="table table-bordered table-striped table-hover dataTable js-exportable">
                                        ...
                                        <tbody>
                                            ...
                                            <td><%=number%></td>
                                                ...
                                                <td>
                                                    <%if (rs.getString("titlemarathi") != null) {%>
                                                    <%=rs.getString("titlemarathi")%><%}%></td>
