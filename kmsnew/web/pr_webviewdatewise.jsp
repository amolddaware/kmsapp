   ...
   <link href="https://cdn.datatables.net/1.10.20/css/jquery.dataTables.min.css" rel="stylesheet" />
    ...
    <body class="theme-blue">
        ...
        <%}%> <%
            ...
            String getData = null, searchQuery = null, room = null, link = null; String fromDate = null, toDate = null;
...
//                if(session.getAttribute("role").equals("5")){
                String sql = "SELECT workcode,brand,location,language,npname,edition,subedition,subject,titlemarathi,sourcedate,sentiment FROM tbl_news_dataentry where "+dateQuery+" and  workcode  like ?  ";
              ...
              //  stm.setString(1, "%P%");
                stm.setString(1, "%W%");
//                }else{
//                 String sql = "SELECT workcode,brand,location,language,npname,edition,subedition,subject,titlemarathi,sourcedate,sentiment FROM tbl_news_dataentry where "+dateQuery+" and userid=? and  workcode  like ? ";
//                //String sql = "Select subject,graphicspath,vdopath,docpath,audiopath  WHERE MATCH (subject, description, summary,general,teletag,districttag,talukatag,villagetag,additionaltag)  AGAINST ('" + subject + "' )";
//                //            String sql = "Select subject,graphicspath,vdopath,docpath,audiopath from tbl_news_dataentry where workcode =?";
//                System.out.println("sql:-" + sql);
//                stm = dh.prepareStatement(sql);
            ...
            <div class="col-md-12"> 
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h2>Web Media Data Entry List</h2>
                                ...
                                <div class="table-responsive">
                                    <table id="example"  class="table table-bordered table-striped table-hover ">
                                        ...
                                        <tbody>
                                            ...
                                            %>
                                            <tr>
                                                    <td><a href="pr_webedit.jsp?workcode=<%=rs.getString("workcode")%>" title="Click Here"  class="btn btn-warning waves-effect"> <i class="material-icons">edit</i></a></td>
