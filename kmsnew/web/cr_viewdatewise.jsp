...
<%
    if (session != null && session.getAttribute("username") != null && (session.getAttribute("role").equals("2") || session.getAttribute("role").equals("2") || session.getAttribute("role").equals("6") || session.getAttribute("role").equals("5"))) {
            ...
            <div class="col-md-12"> 
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h2>Creative Team Data Entry List</h2>
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <form action="cr_viewdatewise.jsp" id="myForm" method="get">
                                ...
                                <div class="table-responsive">
                                    <table id="example"  class="table table-bordered table-striped table-hover ">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="cr_edit.jsp?workcode=<%=rs.getString("workcode")%>" title="Click Here"  class="btn btn-warning waves-effect"> <%=number%> </a>
                                                     </td>
                                               <td><%=rs.getString("workcode")%></td>
                                                ...
                                                <td><%=rs.getString("name_of_program")%></td>
                                                <td><%=rs.getString("place_of_program")%></td>
