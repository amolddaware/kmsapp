...
<html lang="en">
    ...
    <body class="theme-blue">
        ...
        <%String getData = null, searchQuery = null, room = null, link = null;
            ...
            String sql = "SELECT * FROM tbl_news_dataentry where workcode  like '%" + getData + "%' and importance is null order by iddataentry desc";
            ...
            System.out.println("sqlddada:-" + sql);
                                    ...
                                    <table id="example"  class="table table-bordered table-striped table-hover ">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Title</th>
                                                    <%if (request.getParameter("searchresult").equals("N")) {%>
                                                <th>Description</th>
                                                <!--<th>Summary</th>-->
                                                    <%}%>
                                                <th>Source Date</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <%
                                                    if(rs.getString("workcode").contains("MN")){%>     
                                                    <a href="text_news_approver_dataentry_edit.jsp?workcode=<%=rs.getString("workcode")%>" title="Click Here"  class="btn btn-warning waves-effect"> <i class="material-icons">edit</i> </a>
                                                    <%}else if(rs.getString("workcode").contains("N")){%>
                                              
                                                    <a href="<%=link%>?workcode=<%=rs.getString("workcode")%>" title="Click Here"  class="btn btn-warning waves-effect"> <i class="material-icons">edit</i> </a>
