...
<style>
    ...
    .txtFrom{
        width:86%;font-size:0.8rem;border-radius: 3px;padding: 6px 0px;line-height: 1.428571429;color: #000;vertical-align: middle;background-color: #fff;border: none;
    }
    .txtTo{
        width:87%;font-size:0.8rem;border-radius: 3px;padding: 6px 0px;line-height: 1.428571429;color: #000;vertical-align: middle;background-color: #fff;border: none;
    }
    .txtCmbCategory{
    ...
    .divSearch{
        ...
        margin-left: 10px;
        width: 80%;
        height: 40px;margin-top:22px;margin-left: -20px;
    }
    .divSearchFromDate{
        /*margin-left: 10px;*/
        width: 80%;
...
<div class="row"><br>
    ...
    <div class="col-sm-12" style="background-color: #280850;height: 85px;">
        <form action="innerhomepagenew.jsp" id="myForm" method="get">
            <div class="row">
                <div class="col-sm-2">
                    <!--<br>-->
                ...
                <div class="col-sm-3" id="generalTag">
                    <!--<br>-->
...
//                        System.out.println("testsadadadasd:-");
                    ...
                    <%}%>
                    <span id="errGeneral" class="text-danger"> </span>
                </div>
                <div class="col-sm-2 divSearchFromDate bg-white " >
                ...
                <div class="col-sm-2 divSearchToDate bg-white "style="padding-right: 5px;">
                ...
                <div class="col-sm-1   divSearch align-middle ">
                    <button class="sbico-c bg-primary" value="Search" aria-label="" onclick="return valHeader()" type="submit"><span class="sbico z1asCe MZy1Rb "><svg focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M15.5 14h-.79l-.28-.27A6.471 6.471 0 0 0 16 9.5 6.5 6.5 0 1 0 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"></path></svg></span></button>
                ...
                <div class="col-sm-2 align-middle " >
                    <div class="row">
                        <div style="width:85%;">
                            <a class="nav-link profile-pic" style="margin-top:20px;border:1px solid grey;border-radius: 3px;height: 40px;width: 220px" title="<%%>" href="#"><img class="rounded-circle" src="images/faceman.jpg" height="25" width="25" alt="">
                            </a>
                            <!--welcome-->
                            <!--<br>-->
                            &nbsp;&nbsp;&nbsp;
                        ...
                        <div style="width:15%;margin-top:30px;border-radius: 3px;height: 40px;">
                            <a href="logout.do"  style="margin-left:65px;"><img src="images/login_icon.png" height="25" width="25" style="margin-left:10px"></a>
                        </div>
                    </div>
