                                    ...
                                    <table id="example"  class="table table-bordered table-striped table-hover ">
                                        ...
                                        <tbody>
                                           <%
                                            ...
                                            %>
                                            <tr>
                                                <td><a href="dm_edit.jsp?workcode=<%=rs.getString("workcode")%>" title="Click Here"  class="btn btn-warning waves-effect"> <%=number%> </a></td>
                                                <td><%if (rs.getString("dm_source") != null) {%>
                                                    <%=rs.getString("dm_source")%><%}else{%>
                                                   NA<%}%></td>
                                                ...
                                                <td><%=rs.getString("total_engagement")%></td>
