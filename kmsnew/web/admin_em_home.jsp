...
//                                    System.out.println("p:-" + p);
                                ...
                                <div class="sparkline" style="background-color:#83c77f; padding:5px;" data-type="line" data-spot-Radius="4" data-highlight-Spot-Color="rgb(233, 30, 99)" data-highlight-Line-Color="#000"
                                     ...
                                     data-fill-Color="rgba(0, 188, 212, 0)"> <%=c.substring(0, c.length() - 1)%> </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-9">
                        <div class="card">
                            ...
                            <div class="body" style="height: 442px; border-bottom: 4px solid #000; overflow-x: auto">
                                <div class="header text-center">
                                    <h2> RECENT UPLOADS ELECTRONICS MEDIA</h2>
                                    <ul class="header-dropdown m-r--5">
                                        <li class="dropdown">
                                            <!--                                              <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                                                                              <i class="material-icons">more_vert</i>
                                ...
                                <div class="content" style="max-height: 46vh;overflow: auto;">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped table-hovers" id="all_rows">
                                            <tbody>
                                                <%
                                                    String sqlSelects = "SELECT subject,additionaltag,vdopath,sourcedate FROM tbl_news_dataentry where workcode like ? order by iddataentry DESC limit 0,5 ";
                                                    System.out.println("sqlSelect-" + sqlSelects);
                                                    PreparedStatement stmSelects = dh.prepareStatement(sqlSelects);
                                                    stmSelects.setString(1, "%E%");
                                                    ResultSet rsSelects = stmSelects.executeQuery();
                                                    String ssssss = null;

                                                    while (rsSelects.next()) {
                                                        System.out.println("rsSelect.getString():-" + rsSelects.getString("subject"));
                                                %>
                                                <tr>
                                                    <td style="text-align: center;vertical-align: bottom;">
                                                        <%
                                                            if (rsSelects.getString("vdopath") != null) {
                                                                String fullpath[] = null;
                                                                if (rsSelects.getString("vdopath").contains("::")) {
                                                                    fullpath = rsSelects.getString("vdopath").split("::");
                                                        ...
                                                        <%}
                                                        } else if (rsSelects.getString("vdopath") != null) {%>
                                                        <video id="videoContainer"  width="200" height="100" controls >
                                                            <source src="/kmsvdo/<%=rsSelects.getString("vdopath").substring(25)%>" type="video/mp4" >
                                                        </video>
                                                    ...
                                                    <td><h4> <%=rsSelects.getString("subject")%>   </h4>
                                                        <p class="m-t-15 m-b-30"><%if (rsSelects.getString("additionaltag") != null) {%><%=rsSelects.getString("additionaltag")%> <% }%></p>
                        ...
                        <div class="card profile-card">
                            ...
                            <div class="profile-body">
                                ...
                                <div class="content-area">
                                    <h3><%=name%></h3>
                                    <p>Electronic Media Executive</p>
