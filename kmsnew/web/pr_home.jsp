...
<html lang="en">
    ...
    <body class="theme-blue" >
        ...
        <% Connection dh = null;
            ...
            PreparedStatement stmPrint = null;
            ResultSet rsPrint = null;
            String creativeTeam = null, mediaRoom = null, rawData = null, approverData = null, printMedia = null;
            try {
                try {

                    String sqlPrint = "SELECT count(workcode) as tag FROM tbl_news_dataentry where workcode like ? and workcode not like ?";
                    System.out.println("sqlPrint-" + sqlPrint);
                    stmPrint = dh.prepareStatement(sqlPrint);
                    stmPrint.setString(1, "%P%");
                    stmPrint.setString(2, "%PW%");
                    rsPrint = stmPrint.executeQuery();
                    while (rsPrint.next()) {
                        printMedia = rsPrint.getString(1);
                        System.out.println("result:-" + rsPrint.getString(1));
                    }
...
//            count = list.length;
        %>
        <%     PreparedStatement pstmtCal = null;
            ResultSet rst = null;
            try {
                ...
                pstmtCal = dh.prepareStatement(sqlCal);
                rst = pstmtCal.executeQuery();
                while (rst.next()) {
        ...
        <section class="content" style="overflow: hidden">
            <div class="col-md-12 ">
                <%
                    if (session.getAttribute("role").equals("4") || session.getAttribute("role").equals("1")) {%>
                                ...
                                <div class="header text-center">
                                    ...
                                    <ul class="header-dropdown m-r--5">
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu pull-right">
                                                <li><a href="pr_recentuploaded.jsp">Print Media</a></li>
                                                <li><a href="pr_webrecentuploaded.jsp">Web Media</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </div>
                                        ...
                                        <table class="table table-bordered table-striped table-hovers" id="all_rows">
                                            <tbody>
                                                <%
                                                    ...
                                                    try {
                                                        String sqlSelect = "SELECT subject,additionaltag,graphicspath,sourcedate FROM tbl_news_dataentry WHERE userid=? and graphicspath is not null order by iddataentry DESC limit 0,5 ";
...
//                                                                SmbFile ss = new SmbFile(smburl, auth);
                                                        %>
                                                        <img src="/kmsvdo/<%=smburl.substring(25)%>" id="imageContainer" style="width:100%" width="200" height="100"  class="img-responsive">

                                                        <%}%>                                                     
                                                    </td>
                                                    <td><h4> <%=rsSelect.getString("subject")%>   </h4>
                                                        <p class="m-t-15 m-b-30"><%=rsSelect.getString("additionaltag")%> </p>
