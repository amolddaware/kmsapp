...
ResultSet rs =null;
            ...
            try {
                String sql = "SELECT * FROM tbl_news_dataentry where  workcode  like ? and workcode not like ? ";
                                    ...
                                    <table id="example"  class="table table-bordered table-striped table-hover ">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>  <% //if (!rs.getString("graphicspath").isEmpty()) {
//                                                        String path = rs.getString("graphicspath");
...
//                                                        String whiteSpace = fullpath.replace(" ", "%20");
                                                    ...
                                                    %>
                                                    <img src="<%=rs.getString("graphicspath")%>" width="70" height="70">
                                                    <%//} else {%>
                                                    <!--//Upload Image--> 
                                                    <%//}%>
                                                </td>
