  ...
  <link rel="icon" href="images/favicon.ico" type="image/x-icon">
    ...
    <body class="theme-blue" >
        ...
        <%  
            ...
            String sqlPrint = "SELECT count(workcode) as tag FROM tbl_news_dataentry where workcode like ? and userid=? ";
            System.out.println("sqlPrint-" + sqlPrint);
            PreparedStatement stmPrint = dh.prepareStatement(sqlPrint);
            stmPrint.setString(1, "%G%");
            stmPrint.setString(2, userid);
...
//            count = list.length;
        ...
        <section class="content" style="overflow: hidden">
            <div class="col-md-12 ">
                <%                   if (session.getAttribute("role").equals("7") || session.getAttribute("role").equals("1")) {%>
                            ...
                            <div class="body">
                                    ...
                                    <ul class="header-dropdown m-r--5">
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu pull-right">
                                                <li><a href="gr_add.jsp">ADD</a></li>
                                                <li><a href="gr_edit.jsp?searchresult=G">View</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </div>
                                <div class="content bg-blue hover-zoom-effect text-center">
                                    <div class="font-45 count-to card__num" data-from="0" data-to="125" data-speed="1000" data-fresh-interval="20"> 
                                        <i class="material-icons movie">visibility</i><br><%=printMedia%></div>
                                </div>
                                ...
                                <div class="content" style="max-height: 46vh;overflow: auto;">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped table-hovers" id="all_rows">
                                            <tbody>
                                                <%
                                                    String sqlSelect = "SELECT subject,titlemarathi,dept,deptmarathi,docpath,grcode,sourcedate FROM tbl_news_dataentry WHERE userid=? order by iddataentry DESC limit 0,5 ";
                                                ...
                                                %>
                                                <tr>
                                                    <td><a target="_blank" href="<%=rsSelect.getString("docpath")%>">PDF </a></td>
                                                    <td><h4> <%=rsSelect.getString("subject")%>   </h4>
                                                        <p class="m-t-15 m-b-30"><%=rsSelect.getString("titlemarathi")%> </p>
                                                        <p class="m-t-15 m-b-30"><%=rsSelect.getString("dept")%> </p>
                                                        <p class="m-t-15 m-b-30"><%=rsSelect.getString("deptmarathi")%> </p>
                                                        <p class="m-t-15 m-b-30"><%=rsSelect.getString("grcode")%> </p>
