...
//                    dateQuery = " (str_to_date(sourcedate,'%d/%m/%Y') >='" + fromDate + "' AND str_to_date(sourcedate,'%d/%m/%Y') <='" + toDate + "')";
            ...
            try {
                ...
                String sql = "SELECT workcode,brand,location,language,npname,edition,subedition,subject,titlemarathi,sourcedate,sentiment FROM tbl_news_dataentry where "+dateQuery+" and  workcode  like ? and workcode not like ? ";
