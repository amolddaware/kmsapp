...
<html lang="en">
    ...
    <body class="theme-blue">
        ...
        <%String getData = null, searchQuery = null, room = null, link = null;
            ...
            String sql = "SELECT * FROM tbl_news_dataentry where workcode like '%MN%' ";
            ...
            <div class="col-md-12"> 
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h2>Media Room News Dataentry List</h2>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                  ...
                                                  <td><a href="em_newsedit.jsp?workcode=<%=rs.getString("workcode")%>" title="Click Here"  class="btn btn-warning waves-effect"> <i class="material-icons">edit</i> </a></td>
                                            </tr>
                                            <%}%>
                                        </tbody>
                                    </table>
